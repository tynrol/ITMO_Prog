...
public class CCP {
    ...
    public static Command getCommand(String commandLine) throws IOException {
        ...
        return new Command(commandName, index, object);
    }

    //parsing into 1 string
    ...
    //sending by oos
    public static void send(Command cmd, Socket socket) throws IOException{
        if(socket!= null) {
    ...
    //reading from ois
    public static String read(ObjectInputStream ois) throws IOException,ClassNotFoundException{
